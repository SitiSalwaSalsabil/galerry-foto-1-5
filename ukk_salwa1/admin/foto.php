                ...
                <div class="card mt-2">
                    ...
                    <div class="card-body">
                        <form action="../config/aksi_foto.php" method="POST" enctype="multipart/form-data">
                            ...
                            <button type="submit" class="btn btn-primary mt-2" name="tambah" style="font-size: 18px; padding: 12px 20px;">Tambahkan Foto</button>
                        </form>
                    </div>
                </div>
            </div>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                while ($data = mysqli_fetch_array($sql)) {
                                    // Path gambar
                                    $foto_path = "../assets/img/" . $data['lokasifile'];
                                    // Periksa apakah gambar ada
                                    $image_exists = file_exists($foto_path);
                                ?>
                                    <tr>
                                        <td><?php echo $no++ ?></td>
                                        <td>
                                            <?php if ($image_exists) { ?>
                                                <img src="<?php echo $foto_path; ?>" width="100" alt="Foto">
                                            <?php } else { ?>
                                                <img src="../assets/img/default.png" width="100" alt="No Image">
                                            <?php } ?>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <div class="modal fade" id="hapus<?php echo $data['fotoid']; ?>" tabindex="-1" aria-labelledby="modalLabelHapus<?php echo $data['fotoid']; ?>" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <form action="../config/aksi_foto.php" method="POST">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="modalLabelHapus<?php echo $data['fotoid']; ?>">Hapus Data</h5>
                                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                            </div>
                                                            <div class="modal-body">
                                                                <input type="hidden" name="fotoid" value="<?php echo $data['fotoid']; ?>">
